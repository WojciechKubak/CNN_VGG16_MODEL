...
Early stopping allows the model to stop when ovefitting occurs. We set as parameters the metric to be monitored and patience, which specifies how many epochs the model may not improve before stopping.
